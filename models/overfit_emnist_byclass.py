...
def train(model, training_data, callback=True, batch_size=256, epochs=10):
    ...
    if callback == True:
        ...
        tbCallBack = keras.callbacks.TensorBoard(log_dir='./OverfitByClassGraph', histogram_freq=0, write_graph=True, write_images=True)
...
if __name__ == '__main__':
    ...
    train(model, training_data, epochs=25)
